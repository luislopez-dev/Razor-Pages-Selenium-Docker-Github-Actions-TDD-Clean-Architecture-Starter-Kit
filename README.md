...
Some patterns like dtos and isolated use cases have been omitted due to time constraints. I might continue to refine this project in future updates. If you need references on how to use DTOs feel free to review this project: https://github.com/luislopez-dev/.Net-datingApp-web-api/tree/main/datingApp/DTOs
